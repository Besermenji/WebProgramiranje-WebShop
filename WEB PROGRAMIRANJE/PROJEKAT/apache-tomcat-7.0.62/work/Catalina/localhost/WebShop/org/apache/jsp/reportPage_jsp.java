 ...
 * Generated at: 2015-07-06 04:19:08 UTC
...
public final class reportPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("    <title>Izvestaji</title>\n");
      out.write("\n");
      ...
      out.write("    <script src=\"js/reportPageScripts.js\"></script>\n");
      ...
      out.write("\t\t\t<br>\n");
      out.write("\t\t\t<br>\n");
      out.write("\t\t\t<h4 class=\"text-info\">Pretraga izvestaja</h4>\n");
      ...
      out.write("\t\t\t\t\t\t\t<form class=\"navbar-form navbar-left\" role=\"search\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input id=\"startDate\" class=\"form-control\"  placeholder=\"Pocetni datum\" type=\"text\">\n");
      out.write("\t\t\t\t\t\t\t\t</div> \n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t<form class=\"navbar-form navbar-left\" role=\"search\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input id=\"endDate\" class=\"form-control\"  placeholder=\"Krajnji datum\" type=\"text\">\n");
      out.write("\t\t\t\t\t\t\t\t</div> \n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t<form class=\"navbar-form navbar-left\" role=\"search\">\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"izvestaj_dugme\" type=\"button\" class=\"btn btn-default\">\n");
      out.write("\t\t\t\t\t\t\t\t\tGenerisi izvestaje\n");
      out.write("\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</li>\t\n");
      out.write("\t\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t<div id=\"za_tabele\" class=\"col-md-12\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /reportPage.jsp(75,10) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/reportPage.jsp(75,10) '${cat}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${cat}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /reportPage.jsp(75,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
