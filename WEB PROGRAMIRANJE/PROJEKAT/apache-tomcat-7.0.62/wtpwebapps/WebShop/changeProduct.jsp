...
<head>
  ...
  <link rel="shortcut icon" href="img/favicon.png">
	...
	<script type="text/javascript" src="js/changeProductScripts.js"></script>
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<input type="hidden" id="boja" value="${p.color}"></input>	
			<input type="hidden" id="zemlja" value="${p.origin}"></input>
			<input type="hidden" id="kategorija" value="${p.category}"></input>
			<input type="hidden" id="prodavnica" value="${p.salon}"></input>
			<input type="hidden" id="akcijaa" value="${p.action}"></input>
			<input type="hidden" id="procenat" value="${p.percent}"></input>
			<input type="hidden" id="usluga" value="${p.freeService}"></input>
			...
			<form  id="coki" role="form" method="post" action="ProductStartServlet">
				...
				<div class="form-group">
				  ...
				  <div>
				  <input ${r} value="${p.code}" id="code" name="code" placeholder="Unesite sifru namestaja" class="form-control input-md" smk-type="number" minlength="3" maxlength="9"  type="text" required>  
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div>
				  <input value="${p.name}" id="name" name="name" placeholder="Unesite naziv namestaja" class="form-control input-md" type="text" required>  
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div>
				  <input value="${p.producer}" id="producer" name="producer" placeholder="Unesite naziv proizvodjaca" class="form-control input-md" type="text" required>  
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <input value="${p.price}" id="price" name="price" placeholder="Unesite cenu proizvoda(u dinarima)" smk-type="number" minlength="2" maxlength="15" class="form-control input-md" type="text" required>  
				  <div>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <input value="${p.quantity}" id="quantity" name="quantity" placeholder="quantity" smk-type="number" minlength="1" maxlength="15" class="form-control input-md" type="text" required>  
				  <div>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div>
				  <input value="${p.productionYear}" id="productionYear" name="productionYear" placeholder="Unesite godinu proivodnje namestaja" class="form-control input-md" smk-type="number" minlength="3" maxlength="4"  type="text" required>  
				  </div>
				</div>
				...
				<div class="form-group" id="start">
				  ...
				  <div class="hero-unit">
				  <input  value="${p.startDate}"  id="startDate" name="startDate" placeholder="Kliknite za izbor datuma"  type="text">  
				  </div>
				</div>
				...
				<div class="form-group" id="end">
				  ...
				  <div class="hero-unit">
				  <input value="${p.endDate}" id="endDate" name="endDate" placeholder="Kliknite za izbor datuma"  type="text">  
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div>
				  <input value="${p.video}"  id="video" name="video" placeholder="Unesite link videa sa youtube-a" class="form-control input-md" type="text">  
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div>
				  <input value="${p.picture}" id="picture" name="picture" placeholder="Unesite link ili putanju do slike" class="form-control input-md" type="text">  
				  </div>
				</div>
										<input type="hidden" name="user_id" value="${user}"></input>
				 ...
				 <button  name="salonButtonIzmeni"  id="dugme" type="submit" class="btn btn-default">Izmeni namestaj</button>
			</form>
		</div>
	</div>
</div>
