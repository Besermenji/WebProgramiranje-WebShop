...
<head>
  ...
  <link rel="shortcut icon" href="img/favicon.png">
	...
	<script type="text/javascript" src="js/adminLoginScripts.js"></script>
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<br>
			<br>
			<form role="form" method="post" action="AdminLoginServlet">
				<!-- Text input-->
				...
				<div class="form-group">
				 ...
				 <button  name="adminButton"  id="dugme" type="button" class="btn btn-default">Uloguj se!</button>
			</form>
		</div>
	</div>
</div>
