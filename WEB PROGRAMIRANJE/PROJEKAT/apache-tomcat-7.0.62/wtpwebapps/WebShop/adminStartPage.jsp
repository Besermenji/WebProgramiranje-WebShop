...
<html lang="en">
  <head>
    ...
    <script src="js/adminStartScripts.js"></script>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-8">
					<div class="btn-group">
						<form id="saloni_form" action="SalonStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						<form id="kategorije_form" action="CategoryStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						<form id="namestaj_form" action="ProductStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						<form id="servisi_form" action="ServiceStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						<form id="kategorija_akcija_form" action="ActionServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						
						<button id="rad_saloni" class="btn btn-default" type="submit" form="saloni_form">
							 Rad sa salonima
						</button> 
						<button id="rad_kategorije"  class="btn btn-default" type="submit" form="kategorije_form">
							 Rad sa kategorijom namestaja
						</button> 
						<button id="rad_namestaj" class="btn btn-default" type="submit" form="namestaj_form">
							 Rad sa namestajem
						</button> 
						<button id="rad_dodatno" class="btn btn-default" type="submit" form="servisi_form">
							 Rad sa dodatnim uslugama
						</button>
						<button id="akcija_kategorija" class="btn btn-default" type="submit" form="kategorija_akcija_form">
