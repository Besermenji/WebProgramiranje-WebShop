...
<head>
  <meta charset="utf-8">
  <title>Dodaj akciju kategoriji</title>
  ...
  <meta name="author" content="">
	...
	<!--append ÃÂ¢ÃÂÃÂ#!watchÃÂ¢ÃÂÃÂ to the browser URL, then refresh the page. -->
  ...
  <link rel="shortcut icon" href="img/favicon.png">
	...
	<script type="text/javascript" src="js/addCategoryActionScripts.js"></script>
				  ...
				  <div>
				         <select id="percent" name="percent" class="form-control">
							...
							<option value="90">90%</option>
														...
														<input type="hidden" name="cat_ac" value="true"></input>
