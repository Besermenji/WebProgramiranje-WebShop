...
<html lang="en">
  <head>
    ...
    <script src="js/managerStartScripts.js"></script>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-8">
					<div class="btn-group">
						<form id="izvestaj_form" action="ReportStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
						<form id="namestaj_form" action="ProductActionStartServlet" method="post">
							<input type="hidden" name="user_id" value="${param.user}"></input>
						</form>
