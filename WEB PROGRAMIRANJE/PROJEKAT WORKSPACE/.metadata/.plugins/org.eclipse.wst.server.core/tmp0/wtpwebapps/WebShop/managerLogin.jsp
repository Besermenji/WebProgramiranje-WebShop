...
<head>
  ...
  <meta name="author" content="">
	...
	<link href="css/managerLoginStyle.css" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="img/favicon.png">
	...
	<script type="text/javascript" src="js/managerLoginScripts.js"></script>
		...
		<div class="col-md-12 column">
			...
			<form role="form">
				...
				<div class="form-group">
				 ...
				 <button  name="managerButton"  id="dugme" type="button" class="btn btn-default">Uloguj se!</button>
			</form>
		</div>
	</div>
</div>
